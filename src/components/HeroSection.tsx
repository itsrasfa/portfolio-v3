    ...
    <div className="relative h-screen w-full overflow-hidden bg-black">
      <Layout>
        <div className="absolute bottom-0 left-1/2 z-10 h-full w-full -translate-x-1/2 transform overflow-hidden">
          <div
            className="absolute max-sm:bottom-[300px] bottom-[120px] left-1/2 h-[100px] w-[700px] max-sm:w-[300px] max-sm:h-[60px] -translate-x-1/2 transform overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,#5506ba_0%,rgba(10,10,10,0)_100%)] blur-[60px] max-sm:blur-[30px]"
        ...
        <div className="relative z-30 flex h-full flex-col items-center justify-center text-center text-white px-6">
          <h1 className="mx-auto max-w-[900px] text-center text-3xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-white/90 mb-4 leading-snug">
